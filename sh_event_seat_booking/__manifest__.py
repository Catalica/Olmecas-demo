...

{
    ...
    "assets": {
        "web.assets_frontend": [
            'sh_event_seat_booking/static/src/js/jquery.seat-charts.js',
            'sh_event_seat_booking/static/src/css/jquery.seat-charts.css',
            'sh_event_seat_booking/static/src/js/seat_booking.js',
        ],
        "web.assets_backend": [
            'sh_event_seat_booking/static/src/js/eventboard.js',
            'sh_event_seat_booking/static/src/js/jquery.seat-charts.js',
            'sh_event_seat_booking/static/src/css/jquery.seat-charts.css',
        ],
        "web.assets_qweb": [
            'sh_event_seat_booking/static/src/xml/eventboard.xml',
        ]
    },
    'installable': True,
    'auto_install': False,
